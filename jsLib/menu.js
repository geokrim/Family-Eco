function menu_dsk_load() {
  ...
  sidebar_html += "<li>";
  sidebar_html += '<a href="trans.html">';
  ...
  sidebar_html += "<li>";
  sidebar_html += '<a href="users.html">';
  ...
  sidebar_html +=
    '<li><a href="categ1.html"><span class="material-symbols-outlined">looks_one</span><span class="link">Category 1</span></a></li>';
  sidebar_html +=
    '<li><a href="categ2.html"><span class="material-symbols-outlined">looks_two</span><span class="link">Category 2</span></a></li>';
  sidebar_html +=
    '<li><a href="categ3.html"><span class="material-symbols-outlined">looks_3</span><span class="link">Category 3</span></a></li>';
  sidebar_html += "</ul>";
  sidebar_html += "</li>";

  sidebar_html += "<li>";
  sidebar_html += '<a href="stats.html">';
  ...
  sidebar_html += "<li>";
  sidebar_html += '<a href="family.html">';
  ...
  const remainingContent = Array.from(document.body.children).filter(
    (child) => child !== sidebarElement && child !== hamburgerElement
  );
